...
Hypothesis testing (two-proportion z-test), confidence intervals, **confounding and correlation-vs-causation reasoning**, experiment design, and statistical power analysis — implemented in Python with pandas and statsmodels.
